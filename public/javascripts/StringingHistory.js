...
Ext.define('StringingHistoryGrid', {
                      ...
                      Ext.Ajax.request({
                        ...
                        success: function(response) {
                          ...
                          if (response.success) {
                            ...
                            Ext.Msg.alert("Error", "There was a problem deleting the record: " + response.reason);
                          }
                        }
                      });
                    }
    ...
    initEvents: function() {
        this.callParent(arguments);
        //this.addEvents('racketstringingupdated');
    }
});
                  ...
                  buttons: [
                    {
                        ...
                        handler: function() {
                            var store;
                            Ext.Array.each(['tennisStringStore', 'stringersStore'], function(storeName) {
                            ...
                            store.load({
                                ...
                                callback: function(records) {
                                    ...
                                    if (rec) {
                                        ...
                                        rec.set('requested_by', null);
                                        rec.set('dropped_off', null);
                                        form.loadRecord(rec);
                                    }
                                }
                            });
                            /*
                            record = store.first().copy();
                            record.set('strung_on', null);
                            record.set('requested_by', null);
                            record.set('dropped_off', null);
            ...
            },
            {
                  ...
                  listeners: {
                    ...
                    paymentreceived: function(racketStringing, record) {
                        me.fireEvent('racketstringingupdated', me, racketStringing, record);
                    }
                  }
            }
        ];
