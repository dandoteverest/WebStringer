...
Ext.define('StringImageListPanel', {
  ...
  initComponent: function() {
    ...
    this.stringsStore = Ext.data.StoreManager.lookup('stringsByManufacturerStore');

    me.stringsStore.pageSize = 25;

    me.stringsStore.on('beforeload', function(store) {
